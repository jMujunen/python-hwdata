...
from NET import NetworkInterface
from GPU import GpuInfo
from CPU import CpuData
from FAN import Fan
from SYS import SystemTemp
...
def main_menu():
    ...
    while True:  # Event Loop
        ...
        ping_text = ping_box.draw_text(f'{(wifi.ping(destination="1.1.1.1"))}ms', font='Any 30', modifier=2)
        ...
        gpu_text_temp_value = gpu_temp_box.draw_text(f'{gpu.core_temp}°C', font='Any 40', modifier=2)
        ...
        cpu_clock_box.kill(kwarg1=cpu_max_clock_element, kwarg2=cpu_text_max_clock_percent,
            kwarg3=cpu_text_max_clock_used)
        cpu_voltage_box.kill(kwarg1=cpu_voltage_element, kwarg2=cpu_text_voltage_percent,
            kwarg3=cpu_text_voltage_used)
        gpu_usage_box.kill(kwarg1=gpu_useage_element, kwarg2=gpu_usage_text_percent)
        gpu_power_box.kill(kwarg1=gpu_power_element, kwarg2=gpu_text_power_percent, 
            kwarg3=gpu_text_power_used)
        gpu_temp_box.kill(kwarg1=gpu_temp_element, kwarg2=gpu_text_temp_used, kwarg3=gpu_text_temp_value)
